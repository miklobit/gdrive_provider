...
def projectToMapbox(folder,include_app):
...
def toMapboxgl(qgislayers):
    layers, sprites = createLayers(None, qgislayers)
    obj = {
        "version": 8,
        "name": "QGIS project",
        "glyphs": "mapbox://fonts/mapbox/{fontstack}/{range}.pbf",
...
_svgTemplate =  """<?xml version="1.0" encoding="UTF-8" standalone="no"?>
    ...
    width="240px" height="240px" viewBox="0 0 240 240"></svg>"""
